...
while :
do
#ffmpeg -y -i https://nhkradiobkr1-i.akamaihd.net/hls/live/512291/1-r1/1-r1-01.m3u8 -t ${REC_TIME} -metadata comment="user/HLS" -vn -acodec copy -loglevel quiet $outfile
ffmpeg -y -i https://nhkradiobkr1-i.akamaihd.net/hls/live/512291/1-r1/1-r1-01.m3u8 -t ${REC_TIME} -metadata comment="user/HLS" -vn -acodec copy  $outfile  >/dev/null 2>${outfile}_log
